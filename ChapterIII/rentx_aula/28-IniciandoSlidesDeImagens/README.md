...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Iniciando Slides de Imagens, Chapter 03, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIII/rentx_aula/28-IniciandoSlidesDeImagens/rentx/
```
...
Quando pecorre um array com o map, podemos pegar 2 propriedades: 
- O item que ele está pecorrendo.
- O index isto é, qual a posição que ele está no array.

No caso do map do slider, não utilizamos o item no map,
sendo assim omitimos com um _.
