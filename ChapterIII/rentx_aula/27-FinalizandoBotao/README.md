...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Finalizando Botao, Chapter 03, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIII/rentx_aula/27-FinalizandoBotao/rentx/
```
...
- Dica: é uma boa prática, desabilitar o botão que faz uma chamada a API após o click, 
para evitar que o usuário realize multiplas requisições a API.
