...
<h1 align="center"> 
  🚀Interface de Agendamento Concluido🚀
</h1>
...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Aula Interface de Agendamento Concluido, Chapter 03, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIII/rentx_aula/13-InterfaceDeAgendamentoConcluido/rentx/
```
...
```
- Dica para passar a largura de tela:

  - useWindowDimensions - usado dentro do componente react.
