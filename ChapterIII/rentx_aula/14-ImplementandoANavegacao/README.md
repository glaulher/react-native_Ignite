...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Aula Implementando a Navegação, Chapter 03, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIII/rentx_aula/14-ImplementandoANavegacao/rentx/
```
...
```
- Dica:
React Native Gesture Handler, a versão atual necessita que em volta de nossa aplicação utilize o provider GestureHandlerRootView:
...
```
Criar pasta para tipar a navigation: @types/@react-navigation/stack/index.d.ts
