...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Aula Utilizando o JsonServer, Chapter 03, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIII/rentx_aula/15-UtilizandoOJsonServer/rentx/
```
...
```
Para executar o json-server, devemos criar um script em package.json como abaixo: 

```javascript
"scripts": {
    ...,
    "server": "json-server ./src/services/server.json --host 192.168.1.105 --port 3333 --delay 700"
  },
```
OBS: o IP é da máquina local, no linux pegamos o ip com o comando:

```shell
$ ip a
```
No Debian/Ubuntu conseguimos pegar também com o comando abaixo:
