...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Aula Componente de Slider, Chapter 03, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIII/rentx_aula/6-ComponenteDeSlider/rentx/
```
...
```
- Para pegar a dimensão da janela:
...
`;
```
Exemplo de uso da biblioteca react-native-iphone-x-helper :
