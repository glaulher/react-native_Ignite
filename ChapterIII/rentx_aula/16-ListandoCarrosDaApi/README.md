...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Aula Listando Carros da Api, Chapter 03, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIII/rentx_aula/16-ListandoCarrosDaApi/rentx/
```
...
```
O axios é utilizado para lidar com requisições http.

Dica - é recomendável tipar, criando uma interface relacionada aos items da api, exemplo:
