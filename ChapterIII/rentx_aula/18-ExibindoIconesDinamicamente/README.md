...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Aula Exibindo Icones Dinamicamente, Chapter 03, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIII/rentx_aula/18-ExibindoIconesDinamicamente/rentx/
```
...
```
> Dica 
  - passando o método sem ser como função, será executado no momento da renderização do componente.

```javascript
icon={getAccessoryIcon(accessory.type)}
```
  - passando o método como função, será executado no momento do click do botão por exemplo.
