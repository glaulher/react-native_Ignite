...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Transicões, Chapter 03, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIII/rentx_aula/31-Transicoes/rentx/
```
...
```
- withTiming suavisa a animação, podemos passar um objeto com uma duração e o easing, isto é, o comportamento de como será realizada a transição.
...
Exemplo de efeito easing:
- Easing.bounce - Chacoalha no final.
- Easing.ease - começa lento e acelera no final.
- Easing.bezier - podemos personalizar a transição, site [cubic-bezier](https://cubic-bezier.com/) possui opções para personalização.
