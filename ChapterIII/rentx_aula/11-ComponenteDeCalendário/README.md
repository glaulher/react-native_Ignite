...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Aula Componente de Calendário, Chapter 03, Ignite (Rocketseat) - React Native.
...
```
> Dica na estilização do calendário:
  - Deixa apenas o dia atual em diante habilitado no calendário:

```javascript
minDate={String(new Date())}
```
  - Colocar o calendario para iniciar na Segunda:
