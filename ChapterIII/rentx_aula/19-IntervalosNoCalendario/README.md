...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Aula Intervalos No Calendário, Chapter 03, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIII/rentx_aula/19-IntervalosNoCalendario/rentx/
```
...
```
> Dica 
 - Corrigir a data selecionada no calendário, criando dentro de utils o arquivo getPlatformDate:
