...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Previnir Voltar Splash, Chapter 03, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIII/rentx_aula/38-PrevinirVoltarSplash/rentx/
```
...
- Para impedir que retorne a tela do splash temos que desabilitar o retorno da tela com os códigos abaixo:


Android - dentro da screen Home:
```javascript
  useFocusEffect(() => {
