...
<h1 align="center"> 
  🚀Backend do App e cadastro do Usuário🚀
</h1>
...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Backend do App e cadastro do Usuário, Chapter 04, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIV/rentx_aula/13-BackendDoAppEcadastroDoUsuario/rentx/
```
...
Com a atualização do expo obtive alguns warms no terminal, alguns consegui eliminar com os passos abaixo:

adicionei o código abaixo em App.tsx(posteriormente fui retirando o que deixou de alarmar com as atualizações)
...
```
Para ignoreWarnings, além de instalar a biblioteca ignore-warnings, eu tive que tipar, criando uma pasta dentro de @types chamada ignore-warnings com um arquivo index.d.ts:
