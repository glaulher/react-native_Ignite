...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Acessibilidade Em Formulario, Chapter 04, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIV/rentx_aula/5-AcessibilidadeEmFormulario/rentx/
```
...
Para uma melhor experiência no preenchimento de formulário, utilizamos as seguintes tags:

Coloca o que estiver dentro da tag em flutuação
```javascript
  <KeyboardAvoidingView behavior="position" enabled>
```

Captura o click em qualquer ponto da tela, e utiliza o Keyboard para fechamento do teclado:
```javascript
