...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Input De Email, Chapter 04, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIV/rentx_aula/3-InputDeEmail/rentx/
```
...
Para inputText utilizado em e-mail é interessante configurar com os seguintes campos:

- keyboardType="email-address" - O teclado do telefone ficará configurado para entrada de e-mail;

- autoCorrect={false} - Desabilita a auto correção do texto;

- autoCapitalize="none" - Desativa a primeira letra digitada como maiúscula;
