...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Acessibilidade Em Input, Chapter 04, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIV/rentx_aula/6-AcessibilidadeEmInput/rentx/
```
...
✔️ Notas:
 ...
 - Propriedade onFocus do input - quando entramos no input ele é acionado;
 - Propriedade onBlur do input - quando saimos do input ele é acionado;
