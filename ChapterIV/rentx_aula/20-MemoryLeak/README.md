...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Memory Leak, Chapter 04, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterIV/rentx_aula/20-MemoryLeak/rentx/
```
...
Nessa aula foi corrigido o erro de performance relacionado a possível problema em trazer dados da api com o componente desmontado.
Foi utilizado a criação de uma variável chamada isMounted para controlar essa falha.
