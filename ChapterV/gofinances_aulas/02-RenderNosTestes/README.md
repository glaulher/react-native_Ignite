...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Render Nos Testes, Chapter 05, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterV/gofinances_aulas/02-RenderNosTestes/gofinances
```
...
Temos que modificar o packge.json
```javascript
 "jest": {
   "preset": "react-native",
    "setupFilesAfterEnv": [
