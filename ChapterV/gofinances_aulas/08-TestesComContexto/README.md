...
<img align="center" src="https://d33wubrfki0l68.cloudfront.net/554c3b0e09cf167f0281fda839a5433f2040b349/ecfc9/img/header_logo.svg" width="22" /> Testes Com Contexto, Chapter 05, Ignite (Rocketseat) - React Native.
...
$ cd react-native_Ignite/ChapterV/gofinances_aulas/08-TestesComContexto/gofinances
```
...
foi necessario modificar transformIgnorePatterns em jest.config.js conforme abaixo:
...
```
E o script em package.json conforme abaixo:
